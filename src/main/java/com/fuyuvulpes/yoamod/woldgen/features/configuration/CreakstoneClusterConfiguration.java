...
public class CreakstoneClusterConfiguration implements FeatureConfiguration {

    public static final Codec<CreakstoneClusterConfiguration> CODEC = RecordCodecBuilder.create(
            p_160784_ -> p_160784_.group(
                    ...
                    .apply(p_160784_, CreakstoneClusterConfiguration::new)
    );
    ...
    public CreakstoneClusterConfiguration(
