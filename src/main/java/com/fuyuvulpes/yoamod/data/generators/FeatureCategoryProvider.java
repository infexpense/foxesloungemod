...
public class FeatureCategoryProvider extends CategoryProvider {
    public FeatureCategoryProvider(BookProvider parent, String categoryId) {
    ...
    private BookEntryModel makeMultiblockEntry(char location) {
        ...
        var multiBlockIntroPage =
                BookTextPageModel.create() //we start with a text page
        ...
        var multiblockPreviewPage =
                BookMultiblockPageModel.create() //now a page to show a multiblock
