...
public class BoomerangRenderer<T extends BoomerangEntity> extends EntityRenderer<T> {
    ...
    private final BoomerangModel<T> model;


    public BoomerangRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.model = new BoomerangModel<>(pContext.bakeLayer(BoomerangModel.LAYER_LOCATION));
    ...
    public ResourceLocation getTextureLocation(T pEntity) {
        return new ResourceLocation(MODID, "textures/entity/boomerang/"+ pEntity.getVariant().getName() + ".png");
    }
}
