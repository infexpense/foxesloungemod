...
public class YoaTags {
    ...
    public static class Biomes {
        ...
        public static final TagKey<Biome> BLISSWOOD_GROWS = tag("blisswood_grows");


        public static final TagKey<Biome> IS_THE_CREAK = tag("is_the_creaks");
