...
public enum WeaponStats implements WeaponStat{
    ...
    CHAKRAM("chakram", 4, -3.2F, 0.0F, false, false),
    CLAWS("claws", 1, -1.2F, -0.5F, true, false),
    CLAYMORE("claymore", 7, -3.5F, 2F, false, false),
    DAGGER("dagger", 1, -1.6F, 0.0F, false, false),
    GREAT_AXE("great_axe", 10, -3.8F, 3.0F, false, true),
    HARPOON("harpoon", 5, -3.6F, 2.0F, false, false),
    HOLY_RIFLE("holy_rifle", 14, 0.0F, 0.0F, false, true),
    KATANA("katana", 2, -2.0F, 0.0F, false, false),
    LANCE("lance", 4, -3.0F, 4.0F, false, false),
    ...
    RUNIC_AXE("runic_axe", 9, -3.2F, 2.0F, false, true),
    RUNIC_BLADE("runic_blade", 3, -2.6F, 0.0F, false, false) ,
    RUNIC_BLASTER("runic_blaster",16, 0.0F, 0.0F, false, true) ,
    SCISSORS_SWORD("scissors_sword", 5, -3.0F, 1.5F, false, false) ,
    SINGLE_SCISSORS_SWORD("single_scissors_sword", 3, -2.0F, 1.0F, false, false) ,
    ...
    WAR_FAN("war_fan", 2, -2.0F, 0.0F, false, false),
    WHIP_SWORD("whip_sword", 3, -3.0F, 0.0F, false, false)
            ;
