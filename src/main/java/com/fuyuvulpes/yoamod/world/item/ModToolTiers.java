...
public class ModToolTiers {
    ...
    public static final Tier BRONZE = TierSortingRegistry.registerTier(
            new SimpleTier(1,152,5.0F,1.2F,8, YoaTags.Blocks.NEEDS_BRONZE_TOOL,() -> Ingredient.of(YoaItems.BRONZE_INGOT.get()))
    ...
    public static final Tier SILVER = TierSortingRegistry.registerTier(
            new SimpleTier(1,200,5.5F,1.6F,10, YoaTags.Blocks.NEEDS_SILVER_TOOL,() -> Ingredient.of(YoaItems.SILVER_INGOT.get()))
            ,new ResourceLocation(MODID,"silver"), List.of(ModToolTiers.BRONZE),List.of(Tiers.IRON));

    public static final Tier STEEL = TierSortingRegistry.registerTier(
            new SimpleTier(2,680,6.5F,2.2F,8, YoaTags.Blocks.NEEDS_STEEL_TOOL,() -> Ingredient.of(YoaItems.STEEL_INGOT.get()))
    ...
    public static final Tier BISMUTH = TierSortingRegistry.registerTier(
            new SimpleTier(2,1120,7.0F,2.6F,16, YoaTags.Blocks.NEEDS_BISMUTH_TOOL,() -> Ingredient.of(YoaItems.BISMUTH.get()))
    ...
    public static final Tier TITANIUM = TierSortingRegistry.registerTier(
            new SimpleTier(5,5216,11.0F,6.0F,10, YoaTags.Blocks.NEEDS_TITANIUM_TOOL,() -> Ingredient.of(YoaItems.TITANIUM_INGOT.get()))
    ...
    public static final Tier IOLITE = TierSortingRegistry.registerTier(
            new SimpleTier(6,7252,14.0F,9.0F,18, YoaTags.Blocks.NEEDS_IOLITE_TOOL,() -> Ingredient.of(YoaItems.IOLITE.get()))
    ...
    public static final Tier ALEXANDRITE = TierSortingRegistry.registerTier(
            new SimpleTier(7,9600,17.0F,14.0F,16, YoaTags.Blocks.NEEDS_ALEXANDRITE_TOOL,() -> Ingredient.of(YoaItems.ALEXANDRITE.get()))
    ...
    public static final Tier ADAMANTITE = TierSortingRegistry.registerTier(
            new SimpleTier(8,12016,20.0F,19.0F,22, YoaTags.Blocks.NEEDS_ADAMANTITE_TOOL,() -> Ingredient.of(YoaItems.ADAMANTITE_INGOT.get()))
