...
public class BoomerangEntity extends ThrowableItem{

    UUID lastEntityUUID = null;
    int returnTick = 20;
    public BoomerangEntity(Level pLevel, ItemStack item, Entity owner) {
        super(1.5F, 200, 100, YoaEntityTypes.BOOMERANG.get(), pLevel, item, owner);
    }
    ...
    public void tick() {
        ...
        System.out.println("Tick loop A");
        ...
        int testCap = 0;
        while (!this.isRemoved() && testCap < 20) {
            System.out.println("Tick Loop B");
        ...
        System.out.println("Tick Loop C");
    }
    ...
    private void returnToOwner() {
        ...
        if (this.getOwner() == null || !this.getOwner().isAlive()) {
            ...
            if (this.getOwner().getBoundingBox().inflate(1F,1F,1F).contains(this.position())){
                this.discard();
                return;
            }
            System.out.println("OWNER LOOP");
    ...
    protected boolean canHitEntity(Entity pTarget) {
        return super.canHitEntity(pTarget) && pTarget.getUUID() != lastEntityUUID;
    }

    @Override
    protected void onHitBlock(BlockHitResult pResult) {
        if (this.life < returnTick){
            this.life = returnTick + 10;
        }
