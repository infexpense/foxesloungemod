...
public class ThrowingKnifeEntity extends ThrowableItem{
    private boolean canHitEntities = true;
    public ThrowingKnifeEntity(Level pLevel, ItemStack item, Entity owner) {
        super(1.2F, 200, 30, YoaEntityTypes.THROWING_KNIFE.get(), pLevel, item, owner);
    }

    public ThrowingKnifeEntity(EntityType<? extends ThrowingKnifeEntity> pEntityType, Level pLevel) {
